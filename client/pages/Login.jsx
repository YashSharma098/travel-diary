            ...
            <div className="bg-blue-50 rounded-lg shadow-lg p-8 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="p-5 m-2">
                    ...
                    <div>
                        ...
                        <input className="text-black text-xl w-full border border-gray-500 rounded-lg hover:border-blue-400 transition p-3"
                ...
                <p className="text-center font-semibold text-sm text-gray-600">
                    ...
                    <Link to={"/signup"} className="text-blue-500 hover:underline text-md">
                       Signup
                    </Link>
                </p>
